...
ExtractClinicG = function(RawM,myFilePath){
  ...
  sampleAgeInfor <- (2021 - as.numeric(metadata$`Date of biological sampling`))*365
  ...
  RawMList[[1]] = RawM
  RawMList[[2]] = cbind(PlateTRawM,GroupTRawM,CohortTRawM,bloodStainTRawM,sampleAgeTRawM,patientGenderTRaw,patientAgeTRaw)
