...
Funlist = list(HYBNORM,MIDNORMcali,PLATESCALE,CALIBRATION) ### calibrator using tranche 1 reference
#Funlist = list(HYBNORM,MIDNORMcali) ### without calibrator
...
###delete later
sourceData1 = readRDS("sourceData1.rds") ### calibrator using tranche 1 reference
sourceData2 = readRDS("sourceData2.rds") ### without using calibrators

RawM1 = sourceData1$RawM1
RawM2 = sourceData1$RawM2
MySoma11 = sourceData1$MySoma1
MySoma21 = sourceData1$MySoma2
combat_all1 = sourceData1$combat_all
BioMeta1 = sourceData1$BioMeta1
BioMeta2 = sourceData1$BioMeta2

MySoma12 = sourceData2$MySoma1
MySoma22 = sourceData2$MySoma2
combat_all2 = sourceData2$combat_all

sourceData = list("RawM1"=RawM1,"RawM2"=RawM2,"MySoma11"=MySoma11,"MySoma21"=MySoma21,"combat_all1"=combat_all1,
                  "MySoma12"=MySoma12,"MySoma22"=MySoma22,"combat_all2"=combat_all2,
                  "BioMeta1"=BioMeta1,"BioMeta2"=BioMeta2)
saveRDS(sourceData,file="sourceData.rds")
###calibrator using tranche 1 reference: MySoma11, MySoma21;
### without calibrator: MySoma12, MySoma22
