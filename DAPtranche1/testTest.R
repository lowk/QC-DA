...
plot(vbet.vin2[1:9],TestPower2[1:9],type="l",col="red",main="Power Analysis (sample size = OA group sample size)",xlab="Between-cluster to within-cluster variance ratio",ylab="power")
